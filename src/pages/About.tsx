    ...
    <div className="w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-8 animate-in fade-in duration-700">
      ...
      <section className="relative rounded-2xl overflow-hidden h-[300px] md:h-[400px] mb-12 shadow-lg">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent flex flex-col justify-end p-8 md:p-12">
          <h1 className="text-white font-display-xl text-4xl md:text-6xl font-bold mb-4">La Martina</h1>
        ...
        <div className="md:col-span-2 space-y-8">
          <section>
            ...
            <div className="space-y-4 text-on-surface-variant text-lg leading-relaxed">
              <p>
                En <strong>La Martina</strong>, no solo vendemos productos; seleccionamos experiencias. Nacimos con la visión de crear un espacio donde la frescura del mercado se encuentra con la exclusividad de un gourmet.
              </p>
              <p>
                Cada producto en nuestras góndolas ha pasado por un riguroso proceso de selección. Desde las carnes de exportación hasta los vinos de bodegas boutique, nuestra misión es garantizar que solo lo mejor llegue a tu mesa.
              </p>
            </div>
          </section>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-primary text-xl font-bold">0810 222 5316</p>
                  <p className="text-sm text-on-surface-variant">Lunes a Viernes, 9 a 21hs.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  >
                    CÓMO LLEGAR <span className="material-symbols-outlined text-[14px] ml-1">open_in_new</span>
                  </a>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-on-surface-variant">hola@lamartina.com.ar</p>
                </div>
              </div>
            </div>
          </section>
