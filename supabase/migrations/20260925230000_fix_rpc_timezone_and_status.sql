-- Migración para arreglar timezone de pedidos (UTC-3) y estado inicial "Nuevo"
...
BEGIN
  ...
  -- 2. Generar un ID seguro en el servidor
  ...
  INSERT INTO public.orders (
    ...
    p_order->>'dni',
    COALESCE(p_order->>'status', 'Nuevo'), -- CORRECCIÓN: 'Nuevo' en vez de 'Pendiente'
    ...
    TO_CHAR(NOW() AT TIME ZONE 'America/Argentina/Buenos_Aires', 'DD/MM/YYYY, HH24:MI') -- CORRECCIÓN: UTC-3
  );
